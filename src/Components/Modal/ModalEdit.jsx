...
const ModalEdit = (props) => {
    ...
    return (
        <Transition appear show={isOpen} as={Fragment}>
            <Dialog className="fixed inset-0 z-10 flex items-center justify-center overflow-y-auto" aria-hidden="true" open={isOpen} onClose={() => setIsOpen(false)}>
                <Transition.Child
                    as={Fragment}
                ...
                >
                    ...
                    <div className="items-start bg-white h-1/2 w-full md:w-2/5 p-4 border-2 rounded space-y-4">
                        ...
                        <div className="w-full overflow-y-auto h-3/4">
                            ...
                            {typeData === 'partner' && (
                                <EditFormPartner data={data} handleCloseModal={handleCloseModal} handleFetchData={handleFetchData} />
                            )}
